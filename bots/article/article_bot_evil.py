...
class ArticleBot:
    ...
    def __init__(self, name, sites=None, check_interval=60):
        self.name = name
        self.sites = sites or ["https://daily-kingston.legitreal.com/"]
    ...
    def act_on_article(self, article):
        system_msg = (
            "You are a joke bot making misleading content of online articles. "
            "comment on this publication in a way that is misleading or paints the candidate in a negative light. "
        )
        ...
        print(f"[ArticleBotEvil] Commented on {article['title']}: {content}")
